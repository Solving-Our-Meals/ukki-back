...
public class ReportDTO {
    ...
    public ReportDTO(int reportNo, String reportTitle, String reportContent, LocalDate reportDate, int reviewNo, String answerTitle, String answerContent, LocalDate answerDate, InquiryState state) {
